...
class Block:
    ...
    style: StyleInfo | None    # size, size_ratio, bold_ratio — why it was classified so
...
`block.markdown` renders that block alone — the natural unit for a chunker:
...
Python 3.10+. Two dependencies, both permissively licensed and both imported lazily: [pdfplumber](https://github.com/jsvine/pdfplumber) (MIT) and [python-docx](https://github.com/python-openxml/python-docx) (MIT). No AGPL or GPL-family code — notably not PyMuPDF.
